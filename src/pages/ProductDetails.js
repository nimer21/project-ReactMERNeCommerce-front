...
const ProductDetails = () => {
  ...
  const fetchProductDetails = async () => {
    setLoading(true);
    // fetch product details from API using the productId
    // setData({...data, productName: "Product Name",... });
      ...
      <div className="min-h-[200px] flex flex-col lg:flex-row gap-4">
        ...
        <div className="h-96 flex flex-col lg:flex-row-reverse gap-4">
          <div className="h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2">
            <img
              src={activeImage}
              className="h-full w-full object-scale-down mix-blend-multiply" onMouseMove={handleZoomImage} onMouseLeave={handleLeaveImageZoom}
            />
            {/**product zoom */}
            {
              zoomImage && (
                <div className="hidden lg:block absolute min-w-[500px] overflow-hidden min-h-[400px] bg-slate-200 p-1 -right-[510px] top-0">
              <div className="w-full h-full min-h-[500px] min-w-[400px] mix-blend-multiply scale-125"
              style={{
